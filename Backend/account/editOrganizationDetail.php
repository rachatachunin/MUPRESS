...
include "../../dbconnection.php";
 ...
 $sql="SELECT * FROM user LEFT JOIN organization ON user.user_id = organization.user_id WHERE organization.user_id = '".$q."'";
...
echo ' <div class="modal fade" id="EditO'.$row['user_id'].'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">แก้ไขข้อมูลผู้ใช้องค์กร</h4>
                    </div>
                    <div class="modal-body">
                      <form onsubmit="return confirm(\'ยืนยันการตัดสินใจ\');" action ="editOrganization_db.php" method="post" class="form-horizontal" role="form" >
                      ...
                      <div class="form-group">
                          <label for="firstname" class="col-md-3 control-label">ชื่อองค์กร</label>
                          <div class="col-md-9">
                              <input type="text" class="form-control" name="organization_name" placeholder=" '.$row['organization_name'].' " value="'.$row['organization_name'].'" required="true">
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group text-center">
                                <button type="submit" class="btn btn-warning">แก้ไข</button>
                                 <button type="button" class="btn btn-danger" onclick ="deleteOrganization('.$row['user_id'].') ;">ลบ</button>
                       </div>
                      </form>
                    </div>
