                          ...
                          for(var j = 0 ; j < 5  ; j++){
                            ...
                            for(var i = 0 ; i < 4 ;i++) {
                              // products += data[i]['title'] ;
                               ...
                               products += "<a href='single.php?id=" + data[counter]['book_id'] + " ' " + "class='mask'><img class='img-responsive zoom-img' src='/MUPRESS_GIT/Backend/book_management/" + data[counter]['image']+ "' alt='' /></a> ";
